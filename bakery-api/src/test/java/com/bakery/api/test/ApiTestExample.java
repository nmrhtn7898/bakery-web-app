package com.bakery.api.test;

import com.bakery.api.base.AbstractIntegrationTest;
import com.bakery.api.config.custom.WithOauth2AuthenticationTestExecutionListener;
import com.bakery.api.annotation.MockOauth2Authentication;
import com.bakery.api.annotation.MockOauth2Client;
import com.bakery.api.annotation.MockOauth2User;
 ...
 *
 * @see MockOauth2Authentication
 * @see MockOauth2Client
 * @see MockOauth2User
 * @see WithOauth2AuthenticationTestExecutionListener#beforeTestMethod(TestContext)
 */
