...
import com.bakery.auth.config.RestDocsConfig;
import com.bakery.auth.config.TestDataConfig;
import com.bakery.auth.enums.Oauth2GrantType;
...
public abstract class AbstractIntegrationTest {
    ...
    @Autowired
    protected TestDataConfig.TestProperties testProperties;
        ...
        return mockMvc
                .perform(
                        post("/auth/oauth/token")
                                ...
                                .param("code", code)
                                .param("grant_type", Oauth2GrantType.AUTHORIZATION_CODE.toString())
                                .param("redirect_uri", redirectUri)
        ...
        return mockMvc
                .perform(
                        post("/auth/oauth/token")
                                ...
                                .param("grant_type", Oauth2GrantType.PASSWORD.toString())
                                .param("scope", scopes)
                );
    }
        ...
        return mockMvc
                .perform(
                        post("/auth/oauth/token")
                                ...
                                .param("grant_type", Oauth2GrantType.REFRESH_TOKEN.toString())
                                .param("scope", scopes)
                );
    }
        ...
        return mockMvc
                .perform(
                        post("/auth/oauth/token")
                                ...
                                .param("client_id", clientId)
                                .param("client_secret", clientSecret)
                                .param("grant_type", Oauth2GrantType.CLIENT_CREDENTIALS.toString())
                                .param("scope", scopes)
